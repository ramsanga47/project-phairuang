...
const CreateListing = () => {
  ...
  const handleImageSubmit = (e)=>{
    ...
    for(let i =0; i<files.length; i++){
      pormises.push(storeImage(files[i]))
    }
    Promise.all(pormises).then((urls)=>{
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <div className="flex gap-4">
            <input
              ...
              multiple
            />
            <button disabled={uploading} onClick={handleImageSubmit} type="button" className="p-3 text-green-700 border uppercase hover:shadow-lg disabled:opacity-80">
