    ...
    <>
      ...
      >
        <div class="h-full px-3 py-4 overflow-y-auto bg-white dark:bg-gray-800">
          <a href="/" title="" className="flex justify-center p-4">
            <img
              className="w-auto h-8"
              src="https://firebasestorage.googleapis.com/v0/b/phairuang-c34f4.appspot.com/o/Group%207logo.svg?alt=media&token=658bfd66-1c01-4dc3-8c31-1e637d20e239"
              alt=""
            />
          </a>
          <ul class="space-y-2 font-medium pl-11 pt-14 ">
            <li>
              <a
                href="/"
      ...
      <div class=" sm:ml-64 ">
        <div className="p-7 flex items-center gap-5">
          <div className="w-1/3">
            <form class="max-w-md pl-16" onSubmit={handleSubmit}>
              <label
                for="default-search"
              ...
              <div class="relative">
                ...
                />
                <button class="text-white absolute end-2.5 bottom-2.5 bg-[#B42AAE] hover:bg-black focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                  Search
                </button>
              </div>
            </form>
        ...
        <div className="flex-1 pl-24">
          <h1 className="text-3xl font-bold  text-slate-700 ">On Sales</h1>

          <div className=" flex flex-wrap gap-12 pt-5">
